...
//Shop der Kategorie "Haushaltswaren"
public class HaushaltsShop extends Shop
{
	//Konstruktor
	public HaushaltsShop(String name, Float cashback_percentage, String url, Boolean deal) 
	{
